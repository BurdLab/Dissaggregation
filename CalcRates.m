function [term1, term2, term3, term4, term5] = CalcRates(vcon, p, p2)
% 
...
term4 = zeros(n_sections, 1);
term5 = zeros(n_sections, 1);

for isec = 2 : n_sections-1
    
    term4(isec) = c3*c4^isec*vcon(isec);
    term5(isec) = c3*c4^(isec+1)*vcon(isec+1);
