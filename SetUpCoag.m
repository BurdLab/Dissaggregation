function [param, opt] = SetUpCoag(nsections, fd)
%
...
%   22-06-21: First cut.
%
% Code adapted from my previous models. 
%
...
param.n_sections = nsections;            % Nmber of sections
param.kernel     = 'KernelBrown'; % Kernel type
param.d0         = 20e-4;         % Diameter of unit particle [cm] [20e-4]
param.fr_dim     = fd;             % Particle fractal dimension
...
param.growth  = 0.1;             % Specific growth rate in first section [d^{-1}] [0.15]
param.gro_sec = 1;                % Section at which growth in aggregates starts [4]
...
param.t_final = 1.0;             % Final time for integrations [d]
param.delta_t = 0.01;              % Time interval for output [d]
